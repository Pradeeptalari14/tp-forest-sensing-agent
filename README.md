# 🌲 Agentic AI for Forest Applications

> AI remote sensing analyst utilizing PyTorch satellite models. Integrates Telegram reports for wildfire and cover updates.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/forest-sensing-agent/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-forest-sensing-agent.git
cd tp-forest-sensing-agent
```
...
```bash
kubectl port-forward deployment/tp-forest-sensing-agent 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── forest_sensing.py     # Main configuration file
```
...
---
*Generated by [Agentic AI for Forest Applications Studio](https://pradeeptalari14.github.io/portfolio/tools/forest-sensing-agent/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
