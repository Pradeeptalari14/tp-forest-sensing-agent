...
Thank you for your interest in improving the **Agentic AI for Forest Applications** studio resources! 🎉
...
# 2. Clone your fork
git clone https://github.com/YOUR_USERNAME/tp-forest-sensing-agent.git
...
Generated configurations come from the **[Agentic AI for Forest Applications Studio](https://pradeeptalari14.github.io/portfolio/tools/forest-sensing-agent/)**.
